...
if not exist .\MODBUILDER\NEW_BUILDMOD.bat (
	echo.
	echo.%_zBLACKonYELLOW% === PRESS ANY KEY and THIS window will close shortly === %_zDEFAULT%
	echo.        %_zBLACKonYELLOW% === OR use the 'X' at the top right === %_zDEFAULT%
)
...
rem ****seekker*****************************************************
rem *********************************************************
If defined _mdebugS goto :LASTCHANCE 
